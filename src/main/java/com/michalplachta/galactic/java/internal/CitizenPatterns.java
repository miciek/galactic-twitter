...
public class CitizenPatterns {
    public static Tuple1<String> Civilian(Civilian civilian) {
        return Tuple.of(civilian.name);
    }

    public static <_1 extends String> API.Match.Pattern1<? extends Citizen, _1> Civilian(API.Match.Pattern<_1, ?> p1) {
        return API.Match.Pattern1.of(Civilian.class, p1, CitizenPatterns::Civilian);
    }
